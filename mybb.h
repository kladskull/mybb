...
************************************************************************/
	...
	// Platform
	#define WIN32 // Compile for Windows
	//#define LINUX // Compile for Linux

	// Version Information
	#define VERSION  "0126"  // Version Change
	#define DVERSION "1.26" // Version Change
	
	#define DEBUG // Remove this for a release

	#ifdef LINUX
		#define SYSID "L"
		#define SYSNAME "LINUX"
		#define SYSDELIM "/"
		#define SSNID "0126-000-0200000" // Version Change
	#endif

	#ifdef WIN32
		#define SYSID "W"
		#define SYSNAME "MS-WINDOWS"
		#define SYSDELIM "\\"
		#define SSNID "0126-001-0000000" // Version Change
	#endif
	...
	mybbfloat fltexecpop(void);
	void fltexecpush(mybbfloat flt);
	mybbstring strexecpop(void);
